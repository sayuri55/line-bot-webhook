...
PROMPT = (
    ...
    "・電力会社：電気代明細書または申込確認書に記載されている電力会社名を使用する（例：ハルエネ、東京電力、エネパル、ソフトバンク）。申込兼同意書のヘッダーや申込先会社名（U-POWERなど申し込み先）は電力会社として使わない。明細書・申込確認書がない場合のみ、申込兼同意書右側の「現在の電力会社」欄の会社名を使用する。\n"
